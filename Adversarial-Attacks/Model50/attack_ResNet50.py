...
args = {
    ...
    'attacks_dir': '/home/users/atodorova/alisa-thesis/malnet-cnn/attacks-adsware' # Folder where the attacks will be saved
}
...
checkpoint = torch.load("/home/users/atodorova/alisa-thesis/malnet-cnn/phase1_epoch_100.pt", map_location=args['device'])
