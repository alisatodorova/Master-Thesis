...
args['optimizer'] = torch.optim.Adam(args['model_instance'].parameters(), lr=1e-4)
...
checkpoint_path = os.path.join(args['drive_checkpoint_dir'], 'ResNet18-epoch_100.pt')
